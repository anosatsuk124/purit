...
(function($PS) {
  ...
  var init = (function () {
      ...
      return function __do() {
          ...
          Node_FS_Sync.writeTextFile(Node_Encoding.UTF8.value)(".git/" + "description")("Unnamed repository; edit this file 'description' to name the repository.\x0a")();
...
(function($PS) {
  ...
  var main = (function () {
      ...
      throw new Error("Failed pattern match at Main (line 15, column 3 - line 18, column 23): " + [ v.constructor.name ]);
  })();
  exports["main"] = main;
})(PS);
PS["Main"].main();